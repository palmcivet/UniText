<template>
  <div
    id="monaco-markdown-editor"
    style="max-width: 728px; min-height: calc(100vh - 176px); margin: 0 auto;"
    :style="{
...
export default class MonacoMarkdownEditor extends Vue {
  ...
  mounted() {
    ...
    this.editor = monaco.editor.create(
      document.getElementById("monaco-markdown-editor") as any,
      {
        ...
        fontFamily:
          "Source Code Pro, PingFang SC,-apple-system,SF UI Text,Lucida Grande,STheiti,Microsoft YaHei,sans-serif",
      }
    );
