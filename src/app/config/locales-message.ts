export const localesMessage = {
  ...
  en: {
    ...
    actions: "Actions",
    deleteWarning:
      "After deletion, it cannot be revoked. Are you sure you want to delete it?",
    warning: "Warning",
    ...
    change: "Change",
    editorTip:
      "You can insert a separate line <!-- more --> is the abstract separator identifier ( the content before this line is the abstract)",
    saveError: "Save failed",
    privateKeyTip:
      "Please fill in the absolute path, for example: /home/username/.ssh/id_rsa",
    ...
    connectFailed:
      "Remote connection failed, please check repository, username and token settings",
  ...
  fr_FR: {
    ...
    syncError1:
      "Désolé, la synchronisation a rencontré une erreur, veuillez vous référer à",
    syncError2: "pour trouver une solution",
    newVersionTips:
      "Une nouvelle version est disponible, téléchargez la nouvelle version!",
    newArticle: "Nouveau",
    publish: "Publier",
    published: "Publié",
    draft: "Brouillon",
    ...
    actions: "Actions",
    deleteWarning:
      "Après la suppression, celui-ci ne peut plus être révoqué. Êtes-vous sûr de vouloir supprimer ?",
    warning: "Attention",
    ...
    privateKeyTip:
      "Veuillez indiquer le chemin absolu, par exemple: /home/username/.ssh/id_rsa",
    ...
    connectFailed:
      "La connexion à distance a échoué, veuillez vérifier les paramètres du référentiel, du nom d'utilisateur et du token",
    ...
    unsavedWarning:
      "Vous allez perdre tous les changements non sauvegardés, voulez-vous continuer ?",
  ...
  ja_JP: {
    ...
    change: "更新",
    editorTip:
      "文書の後ろに一行の <!-- more --> を追加したら、この部分を摘要としてを表示できます。",
    saveError: "保存失敗しました",
    ...
    connectFailed:
      "接続が失敗しました。リポジトリ名、ユーザー名とトークンを確認してください。",
